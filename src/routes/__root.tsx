  ...
  head: () => ({
    meta: [
      ...
      { title: "SubStore — Premium subscription codes, instant delivery" },
      {
        name: "description",
        content:
          "Buy Netflix, Xbox Game Pass, Spotify, Disney+ and more. Instant digital delivery with buyer protection and 24/7 support.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/83d8876d-d832-4006-a7de-133b026761dd/id-preview-205841e1--9c9fec73-49bc-403d-8724-ac8ea1902005.lovable.app-1784093901417.png",
      },
      {
        name: "twitter:image",
        content:
